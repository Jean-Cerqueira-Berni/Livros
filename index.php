...
<style>
    ...
    <div class="w3-container w3-round-xxlarge w3-display-middle w3-card-4 w3-third w3-deep-purple" style="">
        <div class="w3-center">
            <br>
            <img src="euimg.jpg" alt="Nome" style="width:40%" class="w3-circle w3-margint-op">
        </div>
        <form class="w3-container " action="loginAction.php" method="post">
            <div class="w3-section">
                ...
                <button class="w3-button w3-block w3-blue w3-section w3-padding w3-round " type="submit"><b>Entrar</b></button>
            </div>
        </form>
        <br>
    </div>
